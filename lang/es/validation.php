...
return [
    ...
    | utilizados por la clase validador. Algunas de estas reglas tienen
    | varias versiones, como las reglas de tamaño. Siéntete libre de
    | personalizar cada uno de estos mensajes aquí.
    |
    */
