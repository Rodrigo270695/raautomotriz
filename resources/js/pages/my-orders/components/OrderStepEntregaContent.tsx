...
type OrderStepEntregaContentProps = {
    items: EntryMediaItem[];
};

export function OrderStepEntregaContent({ items }: OrderStepEntregaContentProps) {
    ...
    return (
        <>
            <p className="mb-3 text-sm text-slate-700">
                Fotos y videos de la entrega de tu vehículo.
            </p>
            {items.length > 0 ? (
                            ...
                            >
                                ...
                                >
                                    {isVideoItem ? (
                                        ...
                                        <img
                                            src={item.url}
                                            alt={item.caption ?? 'Foto de entrega'}
                ...
                <p className="text-sm text-slate-400">
                    Aún no hay fotos o videos de entrega para esta orden.
                </p>
            )}
                ...
                >
                    ...
                    >
                        ...
                        {selected.isVideo ? (
                            ...
                            <img
                                src={selected.url}
                                alt={selected.caption ?? 'Foto de entrega'}
