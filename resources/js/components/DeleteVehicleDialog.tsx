...
export function DeleteVehicleDialog({ open, onOpenChange, vehicle, vehiclesIndexPath }: DeleteVehicleDialogProps) {
    ...
    const handleDelete = () => {
        router.delete(`${vehiclesIndexPath}/${vehicle.id}`, {
            preserveScroll: true,
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="border-content-border bg-card w-[calc(100%-1rem)] max-w-md sm:w-full">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        ¿Está seguro de eliminar este vehículo? Esta acción no se puede deshacer.
                    </DialogDescription>
                </DialogHeader>
